...
export default function ThreeStoneSideStones(props) {
  const { nodes, materials } = useGLTF('/models/head/ThreeStone-SideStones.glb')
...
useGLTF.preload('/models/head/ThreeStone-SideStones.glb')